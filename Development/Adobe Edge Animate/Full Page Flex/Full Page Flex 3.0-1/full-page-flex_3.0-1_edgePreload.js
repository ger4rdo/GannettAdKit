...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "http://i.usatoday.net/adsolutions/_common/libs/modernizr/modernizr.js", user: true },
      { load: "http://i.usatoday.net/adsolutions/_common/gannett-ad-kit/event-model-2.0.js", user: true },
      { load: "http://i.usatoday.net/adsolutions/_common/ad-video/jquery.ad-video.yupnope.3.0-1.js", user: true },
      { load: "full-page-flex_3.0-1_edge.js"},
      { load: "full-page-flex_3.0-1_edgeActions.js"}];
...
var plSTF="both",ctrPlS="both",minPlW="240px",maxPlW="768px",plWidth="768px",plHeight="768px";
